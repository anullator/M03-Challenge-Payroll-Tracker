...
const collectEmployees = function() {
  ...
  while (!done) {
    ...
    let salary; 
    while ( isNaN(salary) ) {
      salary = prompt("Enter Salary:", "$0");
    }
    
    // creates object containing employee data from input and appends to the array of employees
    employeesArray.push(
      {
        firstName: fName,
        lastName: lName,
    ...
    // prompts user to enter new employee
